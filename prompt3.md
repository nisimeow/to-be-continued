# WEBSITE CRAWLING FEATURE - PART 1 of 4
## Backend API Route with Gemini REST API

---

## 📋 PROMPT FOR CLAUDE CODE - PART 1

```
Create the backend API route for website crawling with Gemini Flash API.

## STEP 1: Install Dependencies

Only install Cheerio (no Gemini SDK needed):
```bash
npm install cheerio
```
...
Add to .env.local:
```
GEMINI_API_KEY=AIzaSyCTE7Xv_gayig5xV2DEOLzDANdTmJa_2HA
```

## STEP 3: Create API Route

Create file: app/api/crawl/route.ts
